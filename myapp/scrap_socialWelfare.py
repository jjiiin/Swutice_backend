...
dept_kr='사회복지학과'
deptNum=11
def scraping_socialWelfare():
    url="https://welfare.swu.ac.kr/bbs/bbs/?bbs_no=11&page_no=1"
    headers={
    ...
    for index, value in enumerate(announcements):
        ...
        if title_before != title_:
            cnt+=1
            print("cnt"+str(cnt))
            find_link=str(temp[0].a.attrs["value"])
            link="https://welfare.swu.ac.kr/bbs/bbs/view.php?bbs_no=11&data_no="+find_link+"&page_no=1&sub_id="
